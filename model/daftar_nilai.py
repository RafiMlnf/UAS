...
# Menghapus inputan nama
    def hapus(self, nama):
        ...
        if nama in self.nama:
            ...
            print("NAMA {0} TIDAK TERDAFTAR!, silahkan tambahkan nama terlebih dahulu".format(nama))
    ...
    def ubah(self, nama):
        ...
        if input_nama in nama:
            ...
            print("NAMA {0} TIDAK TERDAFTAR! Silahkan tambahkan nama terlebih dahulu".format(input_nama))
